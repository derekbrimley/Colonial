...
_magic_number = 10
_modified_time = 1428385193.480475
_enable_loop = True
...
def render_contents(context,**pageargs):
    ...
    try:
        ...
        if request.user.has_perm('home.agent'):
            ...
            __M_writer('\r\n\r\n\r\n\t\t\t</table>\r\n\t\t\t<div id="form_buttons">\r\n\t\t\t\t<button type="submit" class="btn btn-primary">Submit</button>\r\n\t\t\t\t<a href="/rental/rentals.pay/')
            __M_writer(str( fee.id ))
            __M_writer('/')
            __M_writer(str(customer.id))
            __M_writer('" class="btn btn-success">Pay Fee</a>\r\n\t\t\t\t<a href="/rental/rentals.delete/')
            __M_writer(str( fee.id ))
            __M_writer('/" class="btn btn-danger">Delete Fee</a>\r\n\t\t\t</div>\r\n\t\t</form>\r\n\r\n')
        else:
...
"""
__M_BEGIN_METADATA
{"line_map": {"64": 4, "65": 4, "71": 8, "81": 8, "82": 10, "83": 11, "84": 16, "85": 16, "86": 22, "87": 22, "88": 22, "89": 22, "90": 23, "91": 23, "92": 27, "93": 28, "94": 30, "27": 0, "100": 94, "41": 1, "46": 5, "56": 3, "63": 3}, "uri": "rental.edit_fee.html", "source_encoding": "ascii", "filename": "C:\\Python34\\Projects\\Colonial\\rental\\templates/rental.edit_fee.html"}
__M_END_METADATA
"""
