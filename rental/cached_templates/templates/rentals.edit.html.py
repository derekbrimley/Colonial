...
_magic_number = 10
_modified_time = 1428378129.555237
_enable_loop = True
...
def render_contents(context,**pageargs):
    ...
    try:
        ...
        if request.user.has_perm('home.agent'):
            ...
            __M_writer('" class="btn btn-info">Edit Fee</a>\r\n\t\t\t</div>\r\n\t\t</form>\r\n\r\n')
        else:
...
"""
__M_BEGIN_METADATA
{"uri": "rentals.edit.html", "filename": "C:\\Python34\\Projects\\Colonial\\rental\\templates/rentals.edit.html", "source_encoding": "ascii", "line_map": {"66": 8, "39": 1, "44": 5, "75": 8, "76": 10, "77": 11, "78": 16, "79": 16, "80": 22, "81": 22, "82": 26, "83": 27, "84": 29, "54": 3, "90": 84, "27": 0, "60": 3}}
__M_END_METADATA
"""
